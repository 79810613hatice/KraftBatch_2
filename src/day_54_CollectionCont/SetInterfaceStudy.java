...
public class SetInterfaceStudy {
    public static void main(String[] args) {
        ...
        System.out.println("longSet.add(null) = " + longSet.add(null));// set içinde null yok o yüzden ture döndürdü
        System.out.println("longSet.add(null) = " + longSet.add(null));// null var false döndürdü
        System.out.println("longSet = " + longSet);
        // [null, 2, 3, 4, 70, 7]

        if(!longSet.add(70l)){   // item varsa false döndürür  ! olduğu için true dönüyor if çalışır
            longSet.remove(70l); // ---> bu satırda remove ile 70l yi attık
        }

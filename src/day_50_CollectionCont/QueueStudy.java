...
public class QueueStudy {
    public static void main(String[] args) {
        ...
        //peek()
        System.out.println("numQue.peek() = " + numQue.peek()); //numQue.peek() = 2

        //element()
        System.out.println("numQue.element() = " + numQue.element());//numQue.element() = 2
...
//            System.out.println(numQue.element());
           System.out.println("numQue.peek() = " + numQue.peek()); //numQue.peek() = null
        }

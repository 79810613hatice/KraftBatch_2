...
public class MapInterfaceStudy_2 {
    public static void main(String[] args) {
        ...
        System.out.println("stringSet = " + stringSet); //stringSet = [Ayşe, Ahmet, Veli, Zeynep, Mehmet, Osman, Hatice, Metin]

        //How to remove a key which have specific value
        //how to convert a new from current map
        //take a new map of person mapped ages shoıld be under 25
        ...
        System.out.println("ageMap = " + ageMap);  //{Ayşe=22, Veli=24, Zeynep=24, Mehmet=25, Hatice=24}
        ...
        System.out.println("values = " + values);  // [22, 24, 24, 25, 24]
        ...
        System.out.println("iterValues.hasNext() = " + iterValues.hasNext());// false

        Iterator<Integer> iterValues2 = values.iterator();

        System.out.println("iterValues.hasNext() = " + iterValues2.hasNext()); // true
        System.out.println("---------------------------");

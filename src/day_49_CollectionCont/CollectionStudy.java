...
//        List<Integer> lst2 = new ArrayList<>();  //polymorphic way
        ...
        col.add(5);col.add(80);  // [5, 25, 20, 50, 5, 80]
        ...
        System.out.println("isEmpty() = " + col.isEmpty());  // false --> boş olsa true verirdi

        //remove all
//        col.removeAll(col);  // []
//        col.removeAll(Arrays.asList(50,500));  //remove yapılmak istenen collectionun eşleşen elemanları remove edilir
        System.out.println("col = " + col);  //[25, 20, 50, 5, 80]
        ...
        //contains all
        System.out.println(col.containsAll(Arrays.asList(25, 200)));//true vermesi için yapılan controlde her iki item de bulmalı

        //retains all [25, 20, 50, 5, 80, 60, 70, 90]
//        col.retainAll(Arrays.asList(25,20));  --> [25,20]
//        col.retainAll(Arrays.asList(250,200)); // eğer girilen elemanlar listede yoksa boş bir collection döndürür.
        System.out.println("col = " + col);

        //turring to array  [25, 20, 50, 5, 80, 60, 70, 90]
